...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'vog':
				tex = Paths.getSparrowAtlas('Vog');
				frames = tex;
				animation.addByPrefix('idle', 'Vog idle dance', 24);
				animation.addByPrefix('singUP', 'Vog Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Vog Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'Vog Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'Vog Sing Note LEFT', 24);
			...
			case 'vog-pissed':
				tex = Paths.getSparrowAtlas('Vog-pissed');
				frames = tex;
				animation.addByPrefix('idle', 'Vog-pissed idle dance', 24);
				animation.addByPrefix('singUP', 'Vog-pissed Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Vog-pissed Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'Vog-pissed Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'Vog-pissed Sing Note LEFT', 24);
